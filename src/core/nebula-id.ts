 ...
 */
const generateNebulaId = customAlphabet(NEBULA_ID_ALPHABET, DEFAULT_ID_LENGTH);
 ...
 * ```
 */
export function nebulaId(length: number = DEFAULT_ID_LENGTH): string {
  if (length <= 0) {
